...
.iclosewin {
	background: url(${mibewroot}/images/gplus-image.png) no-repeat scroll -65px -67px rgba(0, 0, 0, 0);
	opacity: 0.6;
	border: none;
		...
		<tr>
			<td width="100%">
			    ...
			    ${else:ct.company.chatLogoURL}
	    			${if:mibewHost}
	        	    	<a onclick="window.open('${page:mibewHost}');return false;" href="${page:mibewHost}">
	        	    		<img src="${mibewroot}/images/livechat.jpg" border="0" alt=""/>
	        	    	</a>
				    ${else:mibewHost}
				    	<img src="${mibewroot}/images/livechat.jpg" border="0" alt=""/>
				    ${endif:mibewHost}
...
${endif:sslLink}
			...
			<td align="right" style="padding-right:17px;">
				...
				<td>
					<table cellspacing="0" cellpadding="0" border="0">
					<tr>
					<td width="95" height="13" bgcolor="#D09221" align="center" style="display: none;" class="www"><a href="${msg:site.url}" title="${msg:company.title}" target="_blank">${msg:site.title}</a></td>
					</tr>
					</table>
				</td>
				<td width="5"></td>
