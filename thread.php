...
/* $newstyle = verifyparam ("newstyle", "/^1$/", "") == "1";
$client = verifyparam("client", "/^1$/", "") == "1";
 */
...
if( $act == "refresh" ) {
	...
	print_thread_messages($thread, $token, $lastid, $isuser,$outformat, $isuser ? null : $operator['operatorid'], "newstyles");
	exit;
